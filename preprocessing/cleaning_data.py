...
#     )
#     abcd["Garden"] = (
#         abcd[["Garden", "Garden surface"]].sum(axis=1, skipna=False).fillna(0)
#     )
...
# def clean_df(abcd):
#     abcd = fuses_terrace(
#         fuses_garden(clean_price(clean_liv_area(clean_liv_room_surf(abcd))))
#     )
...
#     abcd["building_type"] = abcd["building_subtype"].apply(
#         lambda x: "house"
#         if x
#         in [
#             "house",
...
#     abcd = test.fillna(
#         {"Furnished": "None", "Elevator": "None", "Swimming pool": "None"}
#     )
#     abcd = clean_df(abcd)

#     abcd.to_json("assets/test.json")
